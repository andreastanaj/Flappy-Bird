let fImg;
let bImg;
let audio_point = new Audio("pointaudio.wav")
let audio_flap= new Audio("flap.wav")
function preload(){
  fImg = loadImage('flappybird.png');
...
class Bird {
  ...
  draw() {
    fill("#eaff00");
    image(fImg, this.x, this.y, this.size);
...
var pipes = new Pipes(60, 200, 130);
